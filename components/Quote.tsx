...
export default function Quote({ quote, author = '', ...props }: QuoteProps) {
    return (
        <div {...props}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-12 left-0 md:-left-2 top-0 text-gray-300">
            ...
            <blockquote className="p-8 mb-8 text-xl text-gray-600">{quote}</blockquote>
